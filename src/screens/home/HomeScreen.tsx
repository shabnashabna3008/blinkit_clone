...
const App = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Top Spacing with Light Yellow */}
      <View style={styles.topSpacing} />
      
      {/* Header with Location and Profile Cart */}
...
const styles = StyleSheet.create({
  ...
  topSpacing: {
    height: 40,
    backgroundColor: '#FFD700', // Bright yellow top spacing
  },
  header: {
    flexDirection: 'row',
    ...
    paddingVertical: 12,
    backgroundColor: '#FFD700', // Bright yellow header
    borderBottomWidth: 1,
  ...
  deliveryDivider: {
    width: 1,
    height: 20,
    backgroundColor: '#FFD700', // Yellow divider
  },
  deliveryText: {
    color: '#333333',
    fontSize: 13,
  ...
  offerContent: {
    flex: 1,
    backgroundColor: '#FFF9E6', // Light yellow overlay
    padding: 15,
    justifyContent: 'center',
    borderRadius: 15,
  },
